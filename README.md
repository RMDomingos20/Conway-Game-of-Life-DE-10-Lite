...
The Verilog case statement below is synthesized into 9-input LUT structures  
(8 neighbors + current state):
...
The translation from screen coordinates:

\[
(X_{vga}, Y_{vga})
\]

to a 1D memory address is achieved using bit-shifting:
...
1. Connect the DE10-Lite board via USB
2. Connect a VGA monitor
3. Open Quartus Programmer
4. Add the generated `.sof` file
5. Flash the FPGA
...
- Setup/Hold analysis
- VGA timing derivations
- Video controller latency arithmetic
- Toroidal mapping algorithms
